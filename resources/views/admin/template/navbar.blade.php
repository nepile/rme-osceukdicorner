<div class="header d-flex p-3 justify-content-between align-items-center">
  ...
  <div class="dropdown-center">
    ...
    <button class="btn btn-secondary bg-navy" type="button" data-bs-toggle="dropdown" style="height: 45px; width: 45px; padding: 10px; border-radius: 100%; border: 0;" aria-expanded="false">
      <h5 class="mb-0"><strong>{{ Str::substr(session('user.name'), 0, 1) }}</strong></h5>
    </button>
